...
if (scrollBar && !reduceMotion.matches) {
...
if (cursor && !reduceMotion.matches) setInterval(() => cursor.style.opacity = cursor.style.opacity === '0' ? '1' : '0', 530);
